...
, libvorbis, speex, libtheora, libopus, libv4l, zlib
, faad2, flac, ladspaH, ffmpeg, frei0r, dssi, gst_all_1
}:
...
stdenv.mkDerivation {
  ...
  buildInputs =
    [ which ocamlPackages.ocaml ocamlPackages.findlib
      ...
      ocamlPackages.srt ocamlPackages.sedlex_2 ocamlPackages.menhir ocamlPackages.menhirLib ocamlPackages.tsdl
    ];
